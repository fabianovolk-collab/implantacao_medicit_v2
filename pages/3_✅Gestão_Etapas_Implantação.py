...
# Apenas considerar itens realmente marcados, ignorando strings vazias ou espaços
salvo = [i for i in dados["Checklist"].split("|") if i.strip()] if dados["Checklist"] else []

# Calcula a porcentagem de progresso
progresso = calcular_progresso(base, salvo)

# Exibe a barra e o percentual
